...
SIGNAL \scan_instance|In_Reg|L1[1]~1_combout\ : std_logic;
...
PORT MAP (
	clk => \TCLK~combout\,
	datab => \scan_instance|next_state.s_DR_158\,
	datac => \scan_instance|next_state~1_combout\,
	datad => \TRST~combout\,
	aclr => \TRST~combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
PORT MAP (
	clk => \TCLK~combout\,
	datab => \scan_instance|next_state.s_capture_151\,
	datac => \scan_instance|next_state~0_combout\,
	datad => \TRST~combout\,
	aclr => \TRST~combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \scan_instance|Selector3~0_combout\ = ((!\TMS~combout\ & ((\scan_instance|current_state.s_capture~regout\) # (\scan_instance|current_state.s_shift~regout\))))
...
PORT MAP (
	clk => \TCLK~combout\,
	datab => \scan_instance|next_state.s_shift_144\,
...
-- Equation(s):
-- \scan_instance|In_Reg|L2~7_combout\ = ((\TMS~combout\ & ((\scan_instance|current_state.s_capture~regout\) # (\scan_instance|current_state.s_shift~regout\))))
...
PORT MAP (
	clk => \TCLK~combout\,
	datab => \TRST~combout\,
	datac => \scan_instance|In_Reg|L2~7_combout\,
	datad => \scan_instance|next_state.s_update_137\,
	aclr => \TRST~combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\scan_instance|In_Reg|L1[1]~1\ : maxv_lcell
-- Equation(s):
-- \scan_instance|In_Reg|L1[1]~1_combout\ = (\TRST~combout\) # ((!\TMS~combout\ & (!\scan_instance|current_state.s_update~regout\ & \scan_instance|current_state.s_idle~regout\)))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \scan_instance|In_Reg|L1[1]~1_combout\);

-- Location: LC_X3_Y5_N3
\scan_instance|In_Reg|L1[6]\ : maxv_lcell
-- Equation(s):
-- \scan_instance|In_Reg|L1\(6) = DFFEAS((!\TRST~combout\ & (\TDI~combout\ & ((\scan_instance|Selector3~0_combout\)))), GLOBAL(\TCLK~combout\), VCC, , \scan_instance|In_Reg|L1[1]~1_combout\, , , , )
...
PORT MAP (
	...
	aclr => GND,
	ena => \scan_instance|In_Reg|L1[1]~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \scan_instance|In_Reg|L1\(5) = DFFEAS((!\TRST~combout\ & (((\scan_instance|In_Reg|L1\(6) & \scan_instance|Selector3~0_combout\)))), GLOBAL(\TCLK~combout\), VCC, , \scan_instance|In_Reg|L1[1]~1_combout\, , , , )
...
-- Equation(s):
-- \scan_instance|In_Reg|L1\(4) = DFFEAS((!\TRST~combout\ & (((\scan_instance|In_Reg|L1\(5) & \scan_instance|Selector3~0_combout\)))), GLOBAL(\TCLK~combout\), VCC, , \scan_instance|In_Reg|L1[1]~1_combout\, , , , )
...
-- Equation(s):
-- \scan_instance|In_Reg|L1\(3) = DFFEAS((!\TRST~combout\ & (\scan_instance|Selector3~0_combout\ & ((\scan_instance|In_Reg|L1\(4))))), GLOBAL(\TCLK~combout\), VCC, , \scan_instance|In_Reg|L1[1]~1_combout\, , , , )
...
-- Equation(s):
-- \scan_instance|In_Reg|L1\(2) = DFFEAS((!\TRST~combout\ & (\scan_instance|In_Reg|L1\(3) & ((\scan_instance|Selector3~0_combout\)))), GLOBAL(\TCLK~combout\), VCC, , \scan_instance|In_Reg|L1[1]~1_combout\, , , , )
...
-- Equation(s):
-- \scan_instance|In_Reg|L1\(1) = DFFEAS((!\TRST~combout\ & (((\scan_instance|In_Reg|L1\(2) & \scan_instance|Selector3~0_combout\)))), GLOBAL(\TCLK~combout\), VCC, , \scan_instance|In_Reg|L1[1]~1_combout\, , , , )
...
-- Equation(s):
-- \scan_instance|In_Reg|L1\(0) = DFFEAS(((!\TRST~combout\ & (\scan_instance|In_Reg|L1\(1) & \scan_instance|Selector3~0_combout\))), GLOBAL(\TCLK~combout\), VCC, , \scan_instance|In_Reg|L1[1]~1_combout\, , , , )
...
-- Equation(s):
-- \scan_instance|In_Reg|PO[6]~3_combout\ = (((\scan_instance|In_Reg|L2\(6) & !\TRST~combout\)))
...
-- Equation(s):
-- \scan_instance|In_Reg|PO[0]~1_combout\ = (!\TRST~combout\ & (((\scan_instance|In_Reg|L2\(0)))))
...
-- Equation(s):
-- \dut_instance|Equal4~0_combout\ = (!\TRST~combout\ & (\scan_instance|In_Reg|L2\(1) & (\scan_instance|In_Reg|L2\(2) & !\scan_instance|In_Reg|L2\(4))))
...
-- Equation(s):
-- \dut_instance|Equal10~3_combout\ = ((!\scan_instance|In_Reg|L2\(2) & (!\scan_instance|In_Reg|L2\(0) & !\scan_instance|In_Reg|L2\(3))))
...
-- Equation(s):
-- \dut_instance|Equal10~12_combout\ = (!\TRST~combout\ & (\scan_instance|In_Reg|L2\(4) & (\scan_instance|In_Reg|L2\(1) & \dut_instance|Equal10~3_combout\)))
...
-- Equation(s):
-- \dut_instance|terror_current_state~15_combout\ = (\dut_instance|terror_current_state.S4~regout\ & (((!\dut_instance|Equal4~0_combout\) # (!\scan_instance|In_Reg|PO[3]~0_combout\)) # (!\scan_instance|In_Reg|PO[0]~1_combout\)))
...
-- Equation(s):
-- \dut_instance|Equal8~2_combout\ = (!\scan_instance|In_Reg|PO[1]~5_combout\ & (\scan_instance|In_Reg|PO[4]~2_combout\ & (!\scan_instance|In_Reg|PO[3]~0_combout\ & \scan_instance|In_Reg|PO[2]~6_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \scan_instance|In_Reg|PO[1]~5_combout\,
	datab => \scan_instance|In_Reg|PO[4]~2_combout\,
	datac => \scan_instance|In_Reg|PO[3]~0_combout\,
	datad => \scan_instance|In_Reg|PO[2]~6_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \dut_instance|terror_current_state.S0~regout\ = DFFEAS((!\scan_instance|In_Reg|PO[6]~3_combout\ & (!\dut_instance|W4~0_combout\ & ((\dut_instance|terror_current_state.S0~regout\) # (\dut_instance|Equal8~3_combout\)))), 
...
PORT MAP (
	...
	datab => \dut_instance|terror_current_state.S0~regout\,
	datac => \dut_instance|Equal8~3_combout\,
	datad => \dut_instance|W4~0_combout\,
	aclr => GND,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
PORT MAP (
	...
	datad => \dut_instance|Equal8~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \dut_instance|terror_current_state~12_combout\ = (\scan_instance|In_Reg|PO[6]~3_combout\) # ((\dut_instance|Equal4~0_combout\ & (\dut_instance|terror_current_state.S1~regout\ & \dut_instance|Equal4~1_combout\)))
...
-- Equation(s):
-- \dut_instance|terror_current_state~11_combout\ = (\dut_instance|Equal10~12_combout\ & ((\dut_instance|terror_current_state.S2~regout\) # ((\dut_instance|terror_current_state.S3~regout\) # (\dut_instance|terror_current_state.S5~regout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|terror_current_state.S2~regout\,
...
-- Equation(s):
-- \dut_instance|terror_current_state~13_combout\ = (\dut_instance|terror_current_state~12_combout\) # ((\dut_instance|terror_current_state~10_combout\) # ((\dut_instance|terror_current_state~11_combout\) # (\dut_instance|terror_current_state~22_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|terror_current_state~12_combout\,
	datab => \dut_instance|terror_current_state~10_combout\,
	datac => \dut_instance|terror_current_state~11_combout\,
	datad => \dut_instance|terror_current_state~22_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
PORT MAP (
	...
	dataa => \dut_instance|terror_current_state.S2~regout\,
	datab => \scan_instance|In_Reg|PO[6]~3_combout\,
	datac => \dut_instance|terror_current_state~17_combout\,
	datad => \dut_instance|terror_current_state~13_combout\,
	aclr => GND,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
PORT MAP (
	...
	datab => \dut_instance|terror_current_state.S2~regout\,
	datac => \scan_instance|In_Reg|PO[6]~3_combout\,
	datad => \dut_instance|terror_current_state.S3~regout\,
	aclr => GND,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \dut_instance|terror_current_state.S4~regout\ = DFFEAS((!\scan_instance|In_Reg|PO[6]~3_combout\ & ((\dut_instance|terror_current_state~15_combout\) # ((\dut_instance|Equal10~12_combout\ & \dut_instance|terror_current_state.S3~regout\)))), 
-- GLOBAL(\scan_instance|In_Reg|PO\(5)), VCC, , , , , , )
...
PORT MAP (
	clk => \scan_instance|In_Reg|PO\(5),
	dataa => \dut_instance|Equal10~12_combout\,
	datab => \dut_instance|terror_current_state~15_combout\,
	datac => \scan_instance|In_Reg|PO[6]~3_combout\,
	datad => \dut_instance|terror_current_state.S3~regout\,
	aclr => GND,
	devclrn => ww_devclrn,
...
-- Equation(s):
-- \dut_instance|terror_current_state~10_combout\ = (\scan_instance|In_Reg|PO[3]~0_combout\ & (\scan_instance|In_Reg|PO[0]~1_combout\ & (\dut_instance|Equal4~0_combout\ & \dut_instance|terror_current_state.S4~regout\)))
...
PORT MAP (
	...
	datab => \scan_instance|In_Reg|PO[0]~1_combout\,
	datac => \dut_instance|Equal4~0_combout\,
	datad => \dut_instance|terror_current_state.S4~regout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \dut_instance|terror_current_state.S5~regout\ = DFFEAS((\dut_instance|terror_current_state~13_combout\ & (((\dut_instance|terror_current_state~10_combout\ & !\scan_instance|In_Reg|PO[6]~3_combout\)))) # (!\dut_instance|terror_current_state~13_combout\ & 
...
PORT MAP (
	clk => \scan_instance|In_Reg|PO\(5),
	dataa => \dut_instance|terror_current_state.S5~regout\,
	datab => \dut_instance|terror_current_state~10_combout\,
	datac => \scan_instance|In_Reg|PO[6]~3_combout\,
	datad => \dut_instance|terror_current_state~13_combout\,
	aclr => GND,
...
-- Equation(s):
-- \dut_instance|W4~0_combout\ = (((\dut_instance|terror_current_state.S5~regout\ & \dut_instance|Equal10~12_combout\)))
...
PORT MAP (
	...
	datad => \dut_instance|Equal10~12_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \dut_instance|Equal7~2_combout\ = ((!\TRST~combout\ & (\scan_instance|In_Reg|L2\(3) & \dut_instance|Equal4~0_combout\)))
...
PORT MAP (
	...
	datab => \dut_instance|Equal7~2_combout\,
...
-- Equation(s):
-- \dut_instance|gun_current_state.S0~regout\ = DFFEAS((\dut_instance|gun_current_state~9_combout\ & ((\dut_instance|gun_current_state~8_combout\) # ((\dut_instance|gun_current_state~14_combout\) # (\dut_instance|gun_current_state.S0~regout\)))), 
-- GLOBAL(\scan_instance|In_Reg|PO\(5)), VCC, , , , , , )
...
PORT MAP (
	...
	datac => \dut_instance|gun_current_state~14_combout\,
...
-- Equation(s):
-- \dut_instance|gun_current_state~8_combout\ = (\scan_instance|In_Reg|PO[0]~1_combout\ & (!\scan_instance|In_Reg|PO[3]~0_combout\ & (\dut_instance|Equal4~0_combout\ & !\dut_instance|gun_current_state.S0~regout\)))
...
PORT MAP (
	...
	datab => \dut_instance|gun_current_state~8_combout\,
	datac => \dut_instance|gun_current_state~14_combout\,
	datad => \dut_instance|gun_current_state.S1~regout\,
	aclr => GND,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \dut_instance|gun_current_state~14_combout\ = (\dut_instance|gun_current_state.S1~regout\ & (\scan_instance|In_Reg|L2\(0) & (!\TRST~combout\ & \dut_instance|Equal8~2_combout\)))
...
-- Equation(s):
-- \dut_instance|gun_current_state.S2~regout\ = DFFEAS((\scan_instance|In_Reg|PO[6]~3_combout\ & (\dut_instance|gun_current_state.S2~regout\ & ((!\dut_instance|gun_current_state~10_combout\)))) # (!\scan_instance|In_Reg|PO[6]~3_combout\ & 
...
-- Equation(s):
-- \dut_instance|gun_current_state~7_combout\ = (\scan_instance|In_Reg|PO[3]~0_combout\ & (!\scan_instance|In_Reg|PO[0]~1_combout\ & (\dut_instance|Equal4~0_combout\ & \dut_instance|gun_current_state.S2~regout\)))
...
PORT MAP (
	...
	datab => \scan_instance|In_Reg|PO[0]~1_combout\,
	datac => \dut_instance|Equal4~0_combout\,
	datad => \dut_instance|gun_current_state.S2~regout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \dut_instance|knife_current_state~38_combout\ = ((!\dut_instance|knife_current_state.S4~regout\ & ((!\dut_instance|knife_current_state.S3~regout\))))
...
-- pragma translate_on
PORT MAP (
	datab => \dut_instance|knife_current_state.S4~regout\,
	datad => \dut_instance|knife_current_state.S3~regout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \dut_instance|knife_current_state~39_combout\ = (!\scan_instance|In_Reg|PO[6]~3_combout\ & (((\dut_instance|knife_current_state~38_combout\) # (!\dut_instance|Equal4~0_combout\)) # (!\dut_instance|Equal4~1_combout\)))
...
-- Equation(s):
-- \dut_instance|knife_current_state~40_combout\ = (\dut_instance|knife_current_state~51_combout\) # ((!\scan_instance|In_Reg|PO[0]~1_combout\ & (\dut_instance|Equal7~2_combout\ & !\dut_instance|knife_current_state.S2~regout\)))
...
PORT MAP (
	dataa => \scan_instance|In_Reg|PO[0]~1_combout\,
	datab => \dut_instance|Equal7~2_combout\,
	datac => \dut_instance|knife_current_state.S2~regout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|knife_current_state.S0~regout\,
	datac => \dut_instance|knife_current_state~50_combout\,
...
-- Equation(s):
-- \dut_instance|knife_current_state~42_combout\ = ((!\dut_instance|knife_current_state.S4~regout\ & (!\dut_instance|knife_current_state.S3~regout\ & \dut_instance|knife_current_state~41_combout\))) # (!\dut_instance|knife_current_state~39_combout\)
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|knife_current_state.S4~regout\,
...
-- Equation(s):
-- \dut_instance|knife_current_state~10_combout\ = (!\scan_instance|In_Reg|L2\(4) & (\scan_instance|In_Reg|L2\(3) & (!\dut_instance|knife_current_state.S0~regout\ & !\scan_instance|In_Reg|L2\(2))))
...
-- Equation(s):
-- \dut_instance|knife_current_state~50_combout\ = (!\TRST~combout\ & (\scan_instance|In_Reg|L2\(1) & (\scan_instance|In_Reg|L2\(0) & \dut_instance|knife_current_state~10_combout\)))
...
-- Equation(s):
-- \dut_instance|knife_current_state~45_combout\ = (\dut_instance|knife_current_state~51_combout\) # (((\dut_instance|knife_current_state~44_combout\) # (\dut_instance|knife_current_state~50_combout\)) # (!\dut_instance|knife_current_state~39_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|knife_current_state~51_combout\,
	datab => \dut_instance|knife_current_state~39_combout\,
	datac => \dut_instance|knife_current_state~44_combout\,
	datad => \dut_instance|knife_current_state~50_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \dut_instance|knife_current_state.S1~regout\ = DFFEAS((\dut_instance|knife_current_state.S1~regout\ & (((!\scan_instance|In_Reg|PO[6]~3_combout\ & \dut_instance|knife_current_state~50_combout\)) # (!\dut_instance|knife_current_state~45_combout\))) # 
-- (!\dut_instance|knife_current_state.S1~regout\ & (!\scan_instance|In_Reg|PO[6]~3_combout\ & (\dut_instance|knife_current_state~50_combout\))), GLOBAL(\scan_instance|In_Reg|PO\(5)), VCC, , , , , , )
...
PORT MAP (
	clk => \scan_instance|In_Reg|PO\(5),
	dataa => \dut_instance|knife_current_state.S1~regout\,
	datab => \scan_instance|In_Reg|PO[6]~3_combout\,
	datac => \dut_instance|knife_current_state~50_combout\,
	datad => \dut_instance|knife_current_state~45_combout\,
	aclr => GND,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \dut_instance|knife_current_state~44_combout\ = (\dut_instance|knife_current_state.S1~regout\ & (!\scan_instance|In_Reg|PO[0]~1_combout\ & (\scan_instance|In_Reg|PO[3]~0_combout\ & \dut_instance|Equal4~0_combout\)))
...
-- Equation(s):
-- \dut_instance|knife_current_state~25_combout\ = (!\scan_instance|In_Reg|L2\(4) & (!\scan_instance|In_Reg|L2\(2) & (!\scan_instance|In_Reg|L2\(1) & \dut_instance|knife_current_state.S2~regout\)))
...
-- Equation(s):
-- \dut_instance|knife_current_state~51_combout\ = (!\TRST~combout\ & (\scan_instance|In_Reg|L2\(3) & (\scan_instance|In_Reg|L2\(0) & \dut_instance|knife_current_state~25_combout\)))
...
-- Equation(s):
-- \dut_instance|knife_current_state.S3~regout\ = DFFEAS((\dut_instance|knife_current_state~51_combout\ & (((\dut_instance|knife_current_state.S3~regout\ & !\dut_instance|knife_current_state~45_combout\)) # (!\scan_instance|In_Reg|PO[6]~3_combout\))) # 
-- (!\dut_instance|knife_current_state~51_combout\ & (((\dut_instance|knife_current_state.S3~regout\ & !\dut_instance|knife_current_state~45_combout\)))), GLOBAL(\scan_instance|In_Reg|PO\(5)), VCC, , , , , , )
...
-- Equation(s):
-- \dut_instance|knife_current_state~37_combout\ = (\dut_instance|Equal4~0_combout\ & (\dut_instance|Equal4~1_combout\ & (!\scan_instance|In_Reg|PO[6]~3_combout\ & \dut_instance|knife_current_state.S3~regout\)))
...
PORT MAP (
	...
	datac => \dut_instance|knife_current_state~42_combout\,
	aclr => GND,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \dut_instance|W~0_combout\ = (\dut_instance|Equal4~1_combout\ & (((\dut_instance|knife_current_state.S4~regout\ & \dut_instance|Equal4~0_combout\))))
...
-- Equation(s):
-- \dut_instance|Equal1~3_combout\ = ((!\scan_instance|In_Reg|L2\(2) & (!\scan_instance|In_Reg|L2\(4) & !\scan_instance|In_Reg|L2\(3))))
...
-- Equation(s):
-- \dut_instance|Equal1~12_combout\ = (\scan_instance|In_Reg|L2\(1) & (!\TRST~combout\ & (!\scan_instance|In_Reg|L2\(0) & \dut_instance|Equal1~3_combout\)))
...
-- Equation(s):
-- \dut_instance|bomb_current_state~26_combout\ = (!\dut_instance|bomb_current_state~29_combout\ & (((!\dut_instance|bomb_current_state.S1~regout\) # (!\dut_instance|Equal7~2_combout\)) # (!\scan_instance|In_Reg|PO[0]~1_combout\)))
...
PORT MAP (
	...
	datad => \dut_instance|bomb_current_state.S1~regout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
PORT MAP (
	clk => \scan_instance|In_Reg|PO\(5),
	dataa => \dut_instance|Equal1~12_combout\,
	datab => \dut_instance|bomb_current_state.S0~regout\,
	datac => \scan_instance|In_Reg|PO[6]~3_combout\,
	datad => \dut_instance|bomb_current_state~26_combout\,
	aclr => GND,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
PORT MAP (
	dataa => \dut_instance|Equal1~12_combout\,
	datab => \dut_instance|bomb_current_state.S0~regout\,
	datac => \dut_instance|bomb_current_state~22_combout\,
	datad => \dut_instance|bomb_current_state.S3~regout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
PORT MAP (
	...
	datac => \dut_instance|bomb_current_state~23_combout\,
	datad => \dut_instance|bomb_current_state.S1~regout\,
	aclr => GND,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \dut_instance|bomb_current_state~21_combout\ = (\dut_instance|Equal4~0_combout\ & (\scan_instance|In_Reg|PO[3]~0_combout\ & (\dut_instance|bomb_current_state.S1~regout\ & \scan_instance|In_Reg|PO[0]~1_combout\)))
...
-- Equation(s):
-- \dut_instance|bomb_current_state.S2~regout\ = DFFEAS((\dut_instance|bomb_current_state~23_combout\ & (\dut_instance|bomb_current_state~21_combout\ & (!\scan_instance|In_Reg|PO[6]~3_combout\))) # (!\dut_instance|bomb_current_state~23_combout\ & 
...
PORT MAP (
	clk => \scan_instance|In_Reg|PO\(5),
	dataa => \dut_instance|bomb_current_state~21_combout\,
	datab => \scan_instance|In_Reg|PO[6]~3_combout\,
...
-- Equation(s):
-- \dut_instance|bomb_current_state~9_combout\ = (!\scan_instance|In_Reg|L2\(1) & (!\scan_instance|In_Reg|L2\(4) & (\scan_instance|In_Reg|L2\(3) & \dut_instance|bomb_current_state.S2~regout\)))
...
-- Equation(s):
-- \dut_instance|bomb_current_state.S3~regout\ = DFFEAS((\dut_instance|bomb_current_state.S3~regout\ & (((\dut_instance|bomb_current_state~29_combout\ & !\scan_instance|In_Reg|PO[6]~3_combout\)) # (!\dut_instance|bomb_current_state~23_combout\))) # 
-- (!\dut_instance|bomb_current_state.S3~regout\ & (\dut_instance|bomb_current_state~29_combout\ & ((!\scan_instance|In_Reg|PO[6]~3_combout\)))), GLOBAL(\scan_instance|In_Reg|PO\(5)), VCC, , , , , , )
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|W~0_combout\,
	datac => \dut_instance|Equal1~12_combout\,
	datad => \dut_instance|bomb_current_state.S3~regout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \dut_instance|W~regout\ = DFFEAS((!\scan_instance|In_Reg|PO[6]~3_combout\ & ((\dut_instance|W4~0_combout\) # ((\dut_instance|gun_current_state~7_combout\) # (\dut_instance|W~1_combout\)))), GLOBAL(\scan_instance|In_Reg|PO\(5)), VCC, , , , , , )
...
PORT MAP (
	...
	datac => \dut_instance|gun_current_state~7_combout\,
